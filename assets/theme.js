...
var modal = function modal(node) {
  ...
  var modalContent = n$2(selectors$1q.modalContent, node);
  var delegate = new Delegate(document);
  delegate.on("click", selectors$1q.wash, function () {
    return _close();
  });
  var events = [e$2(n$2(selectors$1q.closeBtn, node), "click", function (e) {
    e.preventDefault();
...
var animateImageWithText = (function (node) {
  ...
  delayOffset(node, [selectors$1p.image, selectors$1p.imageSmall, selectors$1p.imageCaption]);
  delayOffset(node, [selectors$1p.sectionBlockItems], 6);
...
var animateImageWithTextSplit = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1o.image]);
  delayOffset(node, [selectors$1o.sectionBlockItems], 6);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateTestimonials = (function (node) {
  ...
  if (a$1(node, classes$A.imageRight)) {
    delayItems.push(selectors$1n.content);
    delayItems.push(selectors$1n.image);
    delayItems.push(selectors$1n.imageCaption);
  } else {
    delayItems.push(selectors$1n.image);
    delayItems.push(selectors$1n.imageCaption);
    delayItems.push(selectors$1n.content);
  ...
  delayOffset(node, [selectors$1n.item]);
});
...
var animateQuotes = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1m.content]);
});
...
var animateListSlider = (function (node) {
  var delayItems = [selectors$1l.sectionBlockItems, selectors$1l.controls, selectors$1l.items]; // Add the animation delay offset variables
...
var animateCompleteTheLook = (function (node) {
  var delayItems = [];
  delayItems.push(selectors$1k.introductionItems); // Create an array of selectors for the animation elements
  // in the order they should animate in

  if (a$1(node, classes$z.imageLeft) || window.matchMedia(getMediaQuery("below-720")).matches) {
    delayItems.push(selectors$1k.image);
    delayItems.push(selectors$1k.products);
    delayItems.push(selectors$1k.product);
  } else {
    delayItems.push(selectors$1k.products);
    delayItems.push(selectors$1k.product);
    delayItems.push(selectors$1k.image);
...
var animateShoppableImage = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1j.introductionItems, selectors$1j.image, selectors$1j.hotspots]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer.destroy();
...
var animateShoppableFeature = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1i.introductionItems, selectors$1i.carousel], 1);
  delayOffset(node, [selectors$1i.hotspots], 1); // Add separate delay offsets for mobile drawer

  delayOffset(node, [selectors$1i.mobileDrawerItems], 1);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer.destroy();
...
var animateImageHeroSplit = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1h.textContent], 1);
});
...
var animateImageHero = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1g.textContent], 3);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateVideoHero = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1f.textContent], 3);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateArticle = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1e.articleHeading, selectors$1e.articleContent]);
  var articleHeading = t$2(selectors$1e.articleHeading, node);
  var articleContent = n$2(selectors$1e.articleContent, node);
...
var animateCollectionBanner = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$1d.image, selectors$1d.content]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateCollection = (function (node) {
  var partial = n$2(selectors$1c.partial, node);
  var filterbarEl = n$2(selectors$1c.filterBar, node);
  var mobileFilterBarEl = n$2(selectors$1c.mobileFilterBar, node);
  ...
  function setupProductItem() {
    var productItems = t$2(selectors$1c.productItems, node);
    delayOffset(node, [selectors$1c.productItems]);
    setTimeout(function () {
      u$1(productItems, classes$y.itemRevealed);
    }, 0);
  ...
  function updateContents() {
    ...
    i$1(partial, classes$y.hideProducts);
...
var animateSalesBanner = (function (node) {
  var leftColumnDelayItems = [selectors$1b.saleAmount, selectors$1b.saleItems];
  var rightColumnDelayItems = [selectors$1b.sectionBlockItems]; // Add the animation delay offset variables
...
var animateCountdownBanner = (function (node) {
  var observer = intersectionWatcher(node);
  delayOffset(node, [selectors$1a.sectionBlockItems]);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
    }
...
var animateBlog = (function (node) {
  delayOffset(node, [selectors$18.headerItems, selectors$18.articleItem, selectors$18.pagination]);
...
var animateDrawerMenu = (function (node) {
  delayOffset(node, [selectors$16.animationItem]); // Trigger the reveal animation when the drawer is opened
...
var animateQuickCart = (function (node) {
  ...
  function setup() {
    delayOffset(node, [selectors$15.animationItem]);
  }
...
var animateQuickView = (function (node) {
  function animate() {
    // Add the animation delay offset variables
    delayOffset(node, [selectors$14.animationItems]); // Trigger the reveal animation when the quick view is opened.
...
var animateMeganav = (function (node) {
  var delayItems = [];
  var columnItems = t$2(selectors$13.columns, node);

  if (a$1(node, selectors$13.hasPromo)) {
    delayOffset(node, [selectors$13.image, selectors$13.overlay, selectors$13.promoItems]);

    if (a$1(node, selectors$13.promoLeft)) {
...
var animateListCollections = (function (node) {
  delayOffset(node, [selectors$12.heading, selectors$12.productItems]);
  var observer = intersectionWatcher(node, true);
  return {
    destroy: function destroy() {
      observer.destroy();
...
var animateGrid = (function (node) {
  delayOffset(node, [selectors$11.gridItems]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer.destroy();
...
var animatePurchaseConfirmation = (function (node) {
  function animate() {
    // Add the animation delay offset variables
    delayOffset(node, [selectors$10.animationItems]);
    delayOffset(node, [selectors$10.animationFooterItems]); // Trigger the reveal animation when the quick view is opened.
...
var animateBlogPosts = (function (node) {
  delayOffset(node, [selectors$Y.headerItems, selectors$Y.articleItem]);
  var observer = intersectionWatcher(node, true);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateCollectionListGrid = (function (node) {
  delayOffset(node, [selectors$W.introductionItems, selectors$W.productItems]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateStoreAvailabilityDrawer = (function (node) {
  function animate() {
    ...
    var items = t$2(selectors$V.animationItems, node);
    items.forEach(function (item, i) {
...
var animateProduct = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$U.media]);
  var observer = intersectionWatcher(node, true);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateContactForm = (function (node) {
  delayOffset(node, [selectors$T.headerItems, selectors$T.animationItem]);
  var observer = intersectionWatcher(node, true);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateSearch = (function (node) {
  var partial = n$2(selectors$S.partial, node);
  var filterbarEl = n$2(selectors$S.filterBar, node);
  var mobileFilterBarEl = n$2(selectors$S.mobileFilterBar, node);
  var filterbarObserver = null;
  ...
  function _setupProductItem() {
    var productItems = t$2(selectors$S.productItems, node);
    delayOffset(node, [selectors$S.productItems]);
    setTimeout(function () {
      u$1(productItems, classes$r.itemRevealed);
    }, 0);
  ...
  function updateContents() {
    ...
    i$1(partial, classes$r.hideProducts);
...
var animateSearchBanner = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$R.content]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animateMultiColumn = (function (node) {
  delayOffset(node, [selectors$Q.headerItems, selectors$Q.columnItems]);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer.destroy();
...
var animatePassword = (function (node) {
  // Add the animation delay offset variables
  delayOffset(node, [selectors$P.textContent], 3);
  var observer = intersectionWatcher(node);
  return {
    destroy: function destroy() {
      observer === null || observer === void 0 ? void 0 : observer.destroy();
...
var animatePopup = (function (node) {
  delayOffset(node, [selectors$O.animationItem]); // Trigger the reveal animation when the drawer is opened
...
var storeAvailabilityDrawer = function storeAvailabilityDrawer(node) {
  ...
  var wash = n$2(selectors$N.wash, node.parentNode);
  var productTitleContainer = n$2(selectors$N.productTitle);
  var variantTitleContainer = n$2(selectors$N.variantTitle);
  var storeListContainer = n$2(selectors$N.storeListContainer, node);
  ...
  var events = [e$2([n$2(selectors$N.closeBtn, node), wash], "click", function (e) {
    e.preventDefault();
  ...
  var _handleClick = function _handleClick(target) {
    var parentContainer = target.closest(selectors$N.parentWrapper);
    ...
    makeRequest("GET", variantSectionUrl).then(function (storeAvailabilityHTML) {
      ...
      var storeList = n$2(selectors$N.storeListContent, container);
  ...
  var delegate = new Delegate(document.body);
  delegate.on("click", selectors$N.drawerTrigger, function (_, target) {
...
var sectionClasses = (function () {
  function adjustClasses() {
    ...
    sections.forEach(function (section) {
      ...
      if (child && child.classList.contains(classes$o.hidden)) {
        u$1(section, classes$o.hidden);
      }
    });
  }
...
var scrollContainer = function scrollContainer(node) {
  var sentinals = t$2(selectors$M.sentinal, node);
  var buttons = t$2(selectors$M.scrollButtons, node);
  var _node$dataset = node.dataset,
      axis = _node$dataset.axis,
      startAtEnd = _node$dataset.startAtEnd;
  var scrollerViewport = n$2(selectors$M.scrollViewport, node);
...
var SocialShare = (function (node) {
  ...
  if (!navigator.clipboard || !navigator.clipboard.writeText) {
    u$1(copyURLButton, classes$n.hidden);
  }
  ...
  function showMessage(message) {
    ...
    i$1(successMessage, classes$n.hidden);
    u$1(popup, classes$n.linkCopied);
    setTimeout(function () {
      u$1(successMessage, classes$n.hidden);
      i$1(popup, classes$n.linkCopied);
    }, 2000);
  }
...
function ProductForm(container, form, prod) {
  ...
  var setIdInputValue = function setIdInputValue(value) {
    var idInputElement = form.querySelector(selectors$L.idInput);
  ...
  var optionInputs = initInputs(selectors$L.optionInput, config.onOptionChange);
  var formQuantityInput = initInputs(selectors$L.quantityInput, config.onQuantityChange);
  var propertyInputs = initInputs(selectors$L.propertyInput, config.onPropertyChange);
...
function switchImage (container, imageId, inYourSpaceButton) {
  var newImage = n$2(selectors$K.imageWrapper + selectors$K.imageById(imageId), container);
  var otherImages = t$2("".concat(selectors$K.imageWrapper, ":not(").concat(selectors$K.imageById(imageId), ")"), container);
  i$1(newImage, classes$m.hidden); // Update view in space button
  ...
  otherImages.forEach(function (image) {
    return u$1(image, classes$m.hidden);
  });
}
...
var informationPopup = function informationPopup(node) {
  var events = [];
  var popupTriggers = t$2(selectors$J.popupTrigger, node);
...
var moreMedia = function moreMedia(node) {
  var moreButton = n$2(selectors$I.moreButton, node);

  if (!moreButton) {
    return;
  }

  var moreBar = n$2(selectors$I.moreBar, node);
  var productMedia = n$2(selectors$I.productMedia, node);
...
function updatePrices (container, variant) {
  var price = t$2(selectors$H.price, container);
  var comparePrice = t$2(selectors$H.comparePrice, container);
...
function updateSku (container, variant) {
  var skuElement = n$2(selectors$G.productSku, container);
  var skuContainer = n$2(selectors$G.productSkuContainer, container);
...
function reviewsHandler (node, container) {
  ...
  var accordion = n$2(selectors$F.accordionShell, container);
  var accordionContent = n$2(selectors$F.accordionContent, accordion); // Move the contents of the reviews app into the accordion shell
  ...
  u$1(parentAppBlockContainer, classes$l.accordion);
  i$1(accordion, classes$l.hidden);
}
...
var inventoryCounter = function inventoryCounter(container, config) {
  ...
  var counterContainer = n$2(selectors$E.counterContainer, container);
  var inventoryMessageElement = n$2(selectors$E.inventoryMessage, container);
  var progressBar = n$2(selectors$E.progressBar, container);
  ...
  l(counterContainer, classes$k.hidden, !productIventoryValid(variantsInventories[config.id]));
  ...
  function checkThreshold(_ref) {
    ...
    if (inventory_management !== null && inventory_policy === "deny") {
      if (inventory_quantity <= 0) {
        u$1(counterContainer, classes$k.inventoryEmpty);
  ...
  var update = function update(variant) {
    l(counterContainer, classes$k.hidden, !variant && !productIventoryValid(variantsInventories[variant.id]));
    if (!variant) return;
...
function stickyScroll (node) {
  var productMeta = n$2(selectors$D.productMeta, node);
...
function ProductItem(container) {
  var items = t$2(selectors$C.item, container);
  ...
  var quickViewButtons = t$2(selectors$C.quickViewButton, container);
...
var Carousel = (function (node) {
  ...
  var swiperContainer = a$1(node, classes$i.carousel) ? node : n$2(selectors$B.sliderContainer, node);
  ...
  var handleOverflow = function handleOverflow(slides) {
    ...
    setTimeout(function () {
      var hasOverflow = a$1(swiperContainer, classes$i.overflow);
      var needsOverflow = t$2(selectors$B.visibleSlides, swiperContainer).length !== slides.length;

      if (!hasOverflow && needsOverflow) {
        u$1(swiperContainer, classes$i.overflow);
      } else if (hasOverflow && !needsOverflow) {
        i$1(swiperContainer, classes$i.overflow);
      }
    }, 0);
  };
...
var featuredProducts = function featuredProducts(node) {
  ...
  var featuredProducts = n$2(selectors$A.leftSideMobileFeaturedProducts, node) || n$2(selectors$A.featuredProducts, node);
  if (!featuredProducts) return;
  var enableMobileSwiper = featuredProducts.dataset.enableMobileSwiper === "true";
  var productItem = ProductItem(featuredProducts);
  var mobileSwiper;
  ...
  function _initMobileSwiper() {
    mobileSwiper = Carousel(featuredProducts, {
      slidesPerView: 2.1,
      spaceBetween: 12
    });
  }
...
var updateUnitPrices = function updateUnitPrices(container, variant) {
  var unitPriceContainers = t$2(selectors$z.unitPriceContainer, container);
  var unitPrices = t$2(selectors$z.unitPrice, container);
  var unitPriceBases = t$2(selectors$z.unitPriceBase, container);
...
var Product = /*#__PURE__*/function () {
  function Product(node) {
    ...
    this.formElement = n$2(selectors$y.form, this.container);
    this.quantityError = n$2(selectors$y.quantityError, this.container);
    this.displayedDiscount = n$2(selectors$y.displayedDiscount, this.container);
    this.viewInYourSpace = n$2("[data-in-your-space]", this.container);
    this.viewInYourSpace && l(this.viewInYourSpace, "visible", isMobile$1());
    this.photosDesktop = n$2(selectors$y.photosDesktop, this.container);
    ...
    this.productThumbnails = n$2(selectors$y.thumbs, this.container);
    this.productThumbnailItems = t$2(selectors$y.thumb, this.container);
    ...
    this.storeAvailabilityContainer = n$2(selectors$y.storeAvailability, this.container);
    this.availability = null; // Handle Shopify Product Reviews if they exist as a product block

    this.reviewsHandler = reviewsHandler(n$2(selectors$y.productReviews, this.container), this.container); // // non-SPR rating display

    var nonSprRatingCount = n$2(selectors$y.nonSprRatingCountLink, this.container);

    if (nonSprRatingCount && !n$2(selectors$y.productReviews, document)) {
  ...
  _createClass(Product, [{
    ...
    value: function _initPhotoCarousel() {
      ...
      var swiperWrapper = n$2(selectors$y.photosMobile, this.container);
      import(flu.chunks.swiper).then(function (_ref) {
        var Swiper = _ref.Swiper,
    ...
    value: function onOptionChange(_ref2) {
      ...
      // Update option label
      var optionParentWrapper = srcElement.closest(selectors$y.productOption);
      var optionLabel = n$2(selectors$y.optionLabelValue, optionParentWrapper);

      if (optionLabel) {
        optionLabel.textContent = srcElement.value;
      }

      var buyButton = n$2(selectors$y.addToCart, this.container);
      var priceWrapper = n$2(selectors$y.priceWrapper, this.container);
      ...
      if (this.displayedDiscount) {
        var newDiscountEl = variant && n$2(selectors$y.displayedDiscountByVariantId(variant.id), this.container);
      ...
      var selectedVariantOpt = n$2("".concat(selectors$y.variantSelect, " ").concat(selectors$y.optionById(variant.id)), this.container);
    ...
    value: function onFormSubmit(e) {
      ...
      var purchaseConfirmation = n$2(selectors$y.purchaseConfirmation, document);
      var quickCart = n$2(selectors$y.quickCart, document);
      ...
      var button = n$2(selectors$y.addToCart, this.container);
      u$1(button, "loading");
      cart.addItem(this.formElement).then(function (_ref4) {
        ...
        var button = n$2(selectors$y.addToCart, _this4.container);
        i$1(button, "loading");
      });
    }
  }, {
    ...
    value: function unload() {
      var _this$quantityInput, _this$mobileSwiper2, _this$stickyScroll, _this$moreMedia, _this$featuredProduct;
...
var quickViewModal = function quickViewModal(node) {
  ...
  var wash = n$2(selectors$x.wash, node);
  var closeButton = n$2(selectors$x.closeBtn, node);
  var modalContent = n$2(selectors$x.modalContent, node);
  var loadingMessage = n$2(selectors$x.loadingMessage, node);
...
var headerOverlay = function headerOverlay(node) {
  if (!node) return;
  var overlay = node;
  var overlayInner = node.querySelector(selectors$w.innerOverlay);
...
function PurchaseConfirmationPopup(node) {
  if (!node) return;
  var quickCartEnabled = Boolean(n$2(selectors$v.quickCart, document));
  var containerInner = n$2(selectors$v.containerInner, node);
  ...
  delegate.on("click", selectors$v.viewCartButton, function (event) {
...
function Disclosure(node) {
  var headerInner = n$2(selectors$u.headerInner);
  var form = node.closest(selectors$u.form);
  var list = n$2(selectors$u.list, node);
  var toggle = n$2(selectors$u.toggle, node);
  var input = n$2(selectors$u.input, node);
  var options = t$2(selectors$u.option, node);
...
register("header", {
  ...
  onLoad: function onLoad() {
    ...
    var cbSelectors = t$2(selectors$t.disclosure, this.container);
...
var passwordUnlock = function passwordUnlock(node) {
  var events = [];
  var popupTriggers = t$2(selectors$s.popupTrigger, node);
...
register("footer", {
  ...
  onLoad: function onLoad() {
    ...
    var headers = t$2(selectors$r.header, this.container);
    ...
    var cbSelectors = t$2(selectors$r.disclosure, this.container);
...
register("announcement-bar", {
  ...
  onLoad: function onLoad() {
    ...
    this.disableTabbingToInners = function () {
      ...
      var desktopOnlyInners = t$2(selectors$q.desktopOnlyInner, this.container);
      var mobileOnlyInners = t$2(selectors$q.mobileOnlyInner, this.container);
    ...
    this.sliderContainer = n$2(selectors$q.slider, this.container);
    this.slides = t$2(selectors$q.slide, this.container);
    this.navPrev = t$2(selectors$q.navPrev, this.container);
    this.navNext = t$2(selectors$q.navNext, this.container);
...
function QuantityButtons(node) {
  var delegate = new Delegate(node);
  delegate.on("click", selectors$p.quantitySubtract, function (_, target) {
    var item = target.closest(selectors$p.item);
    var itemId = item.dataset.id;
    var qty = n$2(selectors$p.quantityInput, item).value;
    r$1("quantity-update:subtract", null, {
      itemId: itemId
    });
    cart.updateItem(itemId, parseInt(qty) - 1);
  });
  delegate.on("click", selectors$p.quantityAdd, function (_, target) {
    var item = target.closest(selectors$p.item);
    var itemId = item.dataset.id;
  ...
  delegate.on("click", selectors$p.removeItem, function (_, target) {
    var item = target.closest(selectors$p.item);
    var itemId = item.dataset.id;
...
function CartNoteToggle(node) {
  var delegate = new Delegate(node);
  delegate.on("click", selectors$o.cartNoteTrigger, function (_, target) {
    return handleCartNoteTrigger(target);
  });

  function handleCartNoteTrigger(target) {
    var inputWrapper = n$2(selectors$o.cartNoteInputWrapper, target.parentNode);
    var textInput = n$2("textarea", inputWrapper); // Handle icon change when open or close

    var plusIcon = n$2(selectors$o.iconPlus, target);
    var minusIcon = n$2(selectors$o.iconMinus, target);
    ...
    if (isVisible(inputWrapper)) {
      ...
      var inputTriggertext = n$2(selectors$o.cartNoteTriggerText, node); // Update cart note trigger text
...
register("quick-cart", {
  onLoad: function onLoad() {
    ...
    this.cartWrapper = n$2(selectors$n.cartWrapper, this.container);
    ...
    this.delegate.on("click", selectors$n.overlay, function () {
      return _this.close();
    });
    this.delegate.on("click", selectors$n.closeButton, function () {
      return _this.close();
    });
    this.delegate.on("change", selectors$n.quantityInput, function (e) {
  ...
  refreshQuickCart: function refreshQuickCart() {
    ...
    makeRequest("GET", url).then(function (response) {
      ...
      var cartHasItems = Boolean(n$2(selectors$n.items, _this2.container));
      ...
      if (responseHasItems && cartHasItems) {
        ...
        var form = n$2(selectors$n.form, _this2.container);
        ...
        var innerContainer = n$2(selectors$n.innerContainer, _this2.container);
  ...
  handleErrorMessage: function handleErrorMessage(itemId) {
    ...
    i$1(n$2(selectors$n.cartError, item), classes$9.hidden);
  ...
  handleQuantityInputChange: function handleQuantityInputChange(_ref4) {
    ...
    var item = target.closest(selectors$n.quantityItem);
    var itemId = item.dataset.id;
...
function Popup(container) {
  ...
  var wash = n$2(selectors$m.wash, container);
  var dismissButtons = t$2(selectors$m.dismissButtons, container);
  var formSuccessMessage = n$2(selectors$m.formSuccessMessage, container);
  ...
  var tab = n$2("".concat(selectors$m.tab, "[data-id=\"").concat(id, "\""));
  ...
  var canPopUp = true;
  ShouldPopUp();
  var events = [e$2(dismissButtons, "click", hidePopup)];
  ...
  if (isSignupPopup) {
    var form = n$2(selectors$m.newsletterForm, container);
  ...
  if (tab) {
    var tabButton = n$2(selectors$m.tabButton, tab);
    var tabDismiss = n$2(selectors$m.tabDismiss, tab);
...
register("collapsible-row-list", {
  onLoad: function onLoad() {
    ...
    this.items = t$2(selectors$l.itemTrigger, this.container);
  ...
  onBlockSelect: function onBlockSelect(_ref) {
    var target = _ref.target;
    var label = n$2(selectors$l.itemTrigger, target);
    var group = label.parentNode,
        content = label.nextElementSibling;
...
function CountdownTimer(container) {
  var settings = n$2(selectors$k.settings, container);
  ...
  var daysEl = n$2(selectors$k.days, container);
  var hoursEl = n$2(selectors$k.hours, container);
  var minutesEl = n$2(selectors$k.minutes, container);
  var secondsEl = n$2(selectors$k.seconds, container);
...
register("countdown-bar", {
  onLoad: function onLoad() {
    ...
    var timers = t$2(selectors$i.timer, this.container);
    this.countdownTimers = [];
    timers.forEach(function (timer) {
      _this.countdownTimers.push(CountdownTimer(timer));
    });
...
register("featured-collection-slider", {
  ...
  _initCarousels: function _initCarousels() {
    ...
    this.productItem = ProductItem(this.container);
    this.carouselsElements = t$2(selectors$h.sliderContainer, this.container);
    this.navItems = t$2(selectors$h.navItems, this.container);
    this.navigationButtons = t$2(selectors$h.navButtons, this.container);
...
register("slideshow", {
  ...
  onLoad: function onLoad() {
    ...
    this.slides = t$2(selectors$f.slide, this.container);
  ...
  handleBulletLabels: function handleBulletLabels() {
    ...
    var bullets = t$2(selectors$f.navigationDot, this.container);
  ...
  handleBlockSelect: function handleBlockSelect(slideIndex) {
    ...
    t$2(selectors$f.navigationLoader, this.container).forEach(function (loader) {
...
register("video-hero", {
  videoHandler: null,
  onLoad: function onLoad() {
    var playButtonVideos = t$2(selectors$d.playButtonVideo, this.container);
    var video = t$2(selectors$d.video, this.container);
...
var navigationDots = function navigationDots(container) {
  var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  var navigationDots = t$2(selectors$c.dots, container);
  var events = [];
...
register("quote", {
  onLoad: function onLoad() {
    ...
    var slides = t$2(selectors$b.slide, this.container);
    ...
    import(flu.chunks.swiper).then(function (_ref) {
      ...
      if (paginationStyle === "dots") {
        ...
        _this.logoNavButtons = t$2(selectors$b.logoNavButton, _this.container);
...
register("shoppable", {
  onLoad: function onLoad() {
    ...
    this.productCards = t$2(selectors$a.productCard, this.container);
    this.hotspotContainers = t$2(selectors$a.hotspotWrappers, this.container);
    this.hotspots = t$2(selectors$a.hotspots, this.container);
    this.wash = n$2(selectors$a.wash, this.container);
    var closeButtons = t$2(selectors$a.closeButtons, this.container); // Self terminating mouseenter events
    ...
    }), e$2(t$2(selectors$a.quickViewTrigger, this.container), "click", function (e) {
  ...
  _initPulseLoop: function _initPulseLoop() {
    var hotspots = t$2(selectors$a.hotspots, this.container);
    var pulseIndex = 0;
  ...
  _createOrRecreateSlider: function _createOrRecreateSlider() {
    ...
    if (this.sliderType !== sliderType) {
      ...
      this.slides = t$2(selectors$a.slide, this.sliderContainer);
      ...
      this.sliderImages = t$2(selectors$a.sliderImages, this.sliderContainer);
...
register("complete-the-look", {
  ...
  onLoad: function onLoad() {
    ...
    this.events = [e$2(t$2(selectors$9.quickViewTrigger, this.container), "click", function (e) {
      var productUrl = e.target.dataset.productUrl;
      if (!productUrl) return;
      r$1("quick-view:open", null, {
        productUrl: productUrl
...
register("image-hero", {
  onLoad: function onLoad() {
    var playButtonVideos = t$2(selectors$5.playButtonVideo, this.container);
...
register("testimonials", {
  ...
  onLoad: function onLoad() {
    ...
    this.items = t$2(selectors$4.item, this.container);
